...
public class ControllerCancelEnrollment {
    ...
    public void setSelectedProfessional(g54.si26.DTOs.ProfessionalDTO professional) {
    ...
    private void updateEnrollmentsTable() {
        ...
        for (Object[] row : enrollments) {
            tableModel.addRow(new Object[]{
                ...
                String.format(java.util.Locale.US, "%.2f", Double.parseDouble(row[4].toString())), row[5]
            });
        }
    ...
    private void updateDetailsPanel() {
        ...
        // Cortamos por si la fecha viene con horas (YYYY-MM-DD HH:MM:SS)
        ...
        try {
            ...
            simDate = LocalDate.now(); // Fallback por si la simulatedDate viene vacía
        }
